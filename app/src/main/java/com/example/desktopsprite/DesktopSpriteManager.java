...
//        int duration = 1000;
//        ObjectAnimator.ofFloat(spriteView,"translationX",spriteView.spriteX,200F).setDuration(duration).start();
//        ObjectAnimator.ofFloat(spriteView,"translationY",spriteView.spriteY,0F).setDuration(duration).start();
